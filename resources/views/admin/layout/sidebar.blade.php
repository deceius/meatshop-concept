    ...
    <nav class="sidebar-nav">
        <ul class="nav">
           ...
           @if (in_array(app('user_tier_id'), app('employee_access')))
            ...
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/transfers') }}"><i class="nav-icon icon-share-alt"></i> Transfer Module </a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/customers') }}"><i class="nav-icon icon-people"></i> Customers </a></li>
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/traders') }}"><i class="nav-icon icon-user"></i> {{ trans('admin.trader.title') }}</a></li>
            @endif
            ...
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/access-tiers') }}"><i class="nav-icon icon-lock"></i> {{ trans('admin.access-tier.title') }}</a></li>
