...
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(static function () {
    Route::prefix('app')->namespace('App\Http\Controllers\Admin')->name('app/')->group(static function() {
        Route::prefix('transaction-details')->name('transaction-details/')->group(static function() {
            ...
            Route::get('/sales-report/export',                          'TransactionDetailsController@salesReportExport')->name('sales-report-export');
            Route::get('/sales-forecasting',                            'TransactionDetailsController@salesForecasting')->name('sales-forecasting');
