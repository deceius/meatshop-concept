...
class FillPermissionsForAccessTier extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAccessTier constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.access-tier',
            'admin.access-tier.index',
            'admin.access-tier.create',
            'admin.access-tier.show',
            'admin.access-tier.edit',
            'admin.access-tier.delete',
            'admin.access-tier.bulk-delete',
        ]);
