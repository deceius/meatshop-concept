...
class FillPermissionsForTransactionDetail extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTransactionDetail constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.transaction-detail.index',
            'admin.transaction-detail.create',
            'admin.transaction-detail.show',
            'admin.transaction-detail.edit',
            'admin.transaction-detail.delete',
            'admin.transaction-detail.bulk-delete',
        ]);
