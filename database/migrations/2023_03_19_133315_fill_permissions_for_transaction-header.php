...
class FillPermissionsForTransactionHeader extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTransactionHeader constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.transaction-header.index',
            'admin.transaction-header.create',
            'admin.transaction-header.show',
            'admin.transaction-header.edit',
            'admin.transaction-header.delete',
            'admin.transaction-header.bulk-delete',
        ]);
